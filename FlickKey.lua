...
local Config = {
    ...
    ServiceId       = 29682, -- Your PlatoBoost Service ID
    PlatoSecret     = "d482cdf1-8849-4b1f-8d3e-08b80400dfe2", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "FlickSecretKeyistaens321", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    ...
    -- [5] File System
    KeyFileName     = "flick_savedkey.txt", -- The name of the file where the valid key will be saved for auto-login
    ...
    HubName         = "Flick", -- The main title shown at the top of the GUI
    HubDescription  = "Nice-feature" -- The text shown below the title
}
